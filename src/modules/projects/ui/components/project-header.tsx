...
import {
    DropdownMenu, DropdownMenuContent, DropdownMenuPortal, DropdownMenuItem, DropdownMenuRadioGroup,
            ...
            <DropdownMenu>
                <DropdownMenuTrigger asChild>
                    ...
                    >
                        ...
                        <span className="text-sm font-medium text-[#52bb3dff]">{project.name}</span>
                        <ChevronDownIcon />
                    </Button>
                </DropdownMenuTrigger>
